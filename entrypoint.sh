...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'1447a764-0752-4d7a-ad7f-e3c2fb1742ac'}
...
ARGO_AUTH='{"AccountTag":"76c23428ff570df82f70345b5dd051fd","TunnelSecret":"ujgQWUDRC5/b81FIcz3Bjjz6YMUa009qjdeevHXxmrA=","TunnelID":"a8684bad-a24c-4231-9406-a1ab1bb877dc"}'
ARGO_DOMAIN=backap.mistakena47.eu.org
